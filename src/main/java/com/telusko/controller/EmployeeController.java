...
public class EmployeeController {
    ...
    public String read(@Valid @ModelAttribute("employee") Employee employee, BindingResult result,Model model){
        if(result.hasErrors()){
            return "employee/demo";
        }
        else{
            employeeService.retrieve(employee,model);
        }
        return "employee/demo";
    }
    ...
    public String updatePage( @ModelAttribute("employee") Client client) {
        return "employee/updateemployee";
    }

    @RequestMapping(value="/updateEmployee",method = RequestMethod.GET)
    public String update(@Valid @ModelAttribute("employee") Employee employee, BindingResult result, Model model){

        if(result.hasErrors()){
            return "employee/result";
        }
        else{
            employeeService.update(employee,model);
        }
